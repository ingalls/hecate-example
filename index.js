        ...
        test('Populate Hecate Instance', (t) => {
            ...
            t.test('Create Data: Parking Spaces Multi* (ingalls)', (q) => {
                request.post({
                    ...
                    body: {
                        "type": "FeatureCollection",
                        "message": "Import Seneca Rocks Parking",
                        "features": [{
                            "type": "Feature",
                            "action": "create",
                            "properties": {
                            ...
                            "geometry": {
                                "type": "MultiPoint",
                                "coordinates": [
                                    [-79.3731227517128, 38.835755815971645],
                                    [-79.37313884496689, 38.8357119406987],
                                    [-79.37316030263901, 38.83566284214694],
                                    [-79.37316298484802, 38.83561896681667],
                                    [-79.37318444252013, 38.83557195750425],
                                    [-79.37320187687874, 38.835523903508346]
                                ]
                            }
                        },{
                            "type": "Feature",
                            ...
                            "geometry": {
                                "type": "MultiPolygon",
                                "coordinates": [
                                    [ [ [ -79.37349691987038, 38.8358592361508 ], [ -79.37337085604668, 38.83579655727228 ], [ -79.37328368425369, 38.83593131679288 ], [ -79.37342181801796, 38.83598459374226 ], [ -79.37349691987038, 38.8358592361508 ] ] ],
                                    [ [ [ -79.37212496995926, 38.835938629317724 ], [ -79.37196403741837, 38.835938629317724 ], [ -79.37196403741837, 38.836099504673825 ], [ -79.37212496995926, 38.836099504673825 ], [ -79.37212496995926, 38.835938629317724 ] ], [ [ -79.37208205461502, 38.83596579011764 ], [ -79.37200024724007, 38.83596579011764 ], [ -79.37200024724007, 38.83605876354659 ], [ -79.37208205461502, 38.83605876354659 ], [ -79.37208205461502, 38.83596579011764 ] ] ]
                                ]
                            }
                        },{
                            "type": "Feature",
                            ...
                            "geometry": {
                                ...
                                "coordinates": [
                                    [[ -79.37397837638855, 38.83656541436778 ], [ -79.37368869781493, 38.83639409366898 ], [ -79.373340010643, 38.83632723669902 ], [ -79.37299132347107, 38.83630216531911 ], [ -79.37272310256958, 38.83620605828093 ]],
                                    [[ -79.37261581420898, 38.836026379557026 ], [ -79.37258899211884, 38.83574641412972 ], [ -79.37264800071716, 38.835399589759696 ], [ -79.37286794185638, 38.83516558682027 ], [ -79.37287867069244, 38.83513633639875 ]]
                                ]
                            }
                        }]
                    }
